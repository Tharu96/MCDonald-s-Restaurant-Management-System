    ...
    private void getPaid(MouseEvent event) {
        try {
            ...
            if (placeOrder(ordersDTO, allOrdersDetails, allOrderedMeals)) {
                ...
                //PrintRepo
                JasperReport compiledReport = (JasperReport) JRLoader.loadObject(OrderController.class.getResourceAsStream("/lk/mc/cashier/report/jasper/OrderInvoice.jasper"));

                HashMap<String, Object> reportParams = new HashMap<>();
//                reportParams.put("CustomerName", customerDTO.getCustName());
...
//                reportParams.put("Quantity", ordersDTO.getQty());
                ...
                frmJasperViewer.setTitle("Top Customers");
